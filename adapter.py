...
DATA_PATH = '/home/isuzu/Desktop/waymo-open-dataset/waymo_dataset'
# path to save kitti dataset
# KITTI_PATH = '/home/cyrus/Research/Waymo_Kitti_Adapter/kitti_dataset'
KITTI_PATH = '/home/isuzu/Desktop/waymo-open-dataset/kitti_dataset'
...
class Adapter:
    ...
    def save_calib(self, frame, frame_num):
        ...
        R0_rect_np = np.array([0,-1,0,  0,0,-1,   1,0,0]).reshape(3,3)
        R0_rect = ["%e" % i for i in R0_rect_np.flatten()]
